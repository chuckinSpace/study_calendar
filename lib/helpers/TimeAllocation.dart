...
class TimeAllocation {
  ...
  Future<List<EventFromDevice>> getEventsFromDevice() async {
    ...
    try {
      ...
      eventsFromDevice = await device.retrieveEventsFromDevice(userData);
  ...
  Future<int> calculateSessions(BuildContext context) async {
    try {
      ...
      this.night = userData.night;
      this.morning = userData.morning;
      this.nightOwl = userData.nightOwl;
      this.sweetSpotStart = userData.sweetSpotStart;
      this.sweetSpotEnd = userData.sweetSpotEnd;
